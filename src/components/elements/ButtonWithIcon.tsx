...
export const ButtonWithIcon: FC<Props> = ({ text, children }) => {
  return (
    <button className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all border-solid border-2 border-white rounded hover:bg-white group mx-5 my-2">
